 ...
 * @ORM\Entity(repositoryClass="Ferus\ProductBundle\Repository\PrevisRepository")
 */
class Previs
{
    /**
    ...
    /**
     * @ORM\OneToOne(targetEntity="Event", inversedBy="previs")
     * @ORM\JoinColumn(name="event_id", referencedColumnName="id", nullable=true, onDelete="SET NULL")
     */
    private $event;

    /**
     * @ORM\OneToMany(targetEntity="PrevisProduct", mappedBy="previs", cascade={"all"}, orphanRemoval=true)
     */
